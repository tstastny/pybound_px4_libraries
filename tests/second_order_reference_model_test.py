...
pos_filt_fb[0] = position_speed_filter.getState()
vel_filt_fb[0] = position_speed_filter.getRate()
for ind in range(1, num_steps):
    position_speed_filter.update(time_step, pos[ind], vel[ind])
    pos_filt_fb[ind] = position_speed_filter.getState()
    vel_filt_fb[ind] = position_speed_filter.getRate()
